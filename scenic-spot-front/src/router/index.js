  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'reports', redirect: '/reports/flow' },
        { path: 'reports/flow', component: () => import('../views/admin/FlowReportView.vue') },
        { path: 'reports/sales', component: () => import('../views/admin/SalesReportView.vue') },
